...
make -j
```
_Note: Look into necessary flags to compile_
_Maybe use whisper-web-transcriber instead? TBD_
...
_Note: We can't upload the trained models to hugging face, to look into_

## For reconstruction
if we can't use the Alberta tools
...
## Currently on splat ex:
the transformers.js whisper model already works I've added it as an example
